...
public class ShortHelperActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_helper);
    }
    ...
    private Intent getShortCutIntent() {
        ...
        intent.setClass(ShortHelperActivity.this, ShortcutActivity.class);
        return intent;
    }
...
//        ShortcutBadger.with(getApplicationContext()).count(9);
        BadgeUtil.setBadgeCount(getApplicationContext(), 4, R.mipmap.ic_launcher);
    }
