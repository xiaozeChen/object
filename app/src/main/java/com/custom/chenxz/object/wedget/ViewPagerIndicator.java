...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * tab颜色变化
     */
    private List<Integer> mTabColors;
    /**
     * 与之绑定的ViewPager
     */
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        argbEvaluator = new ArgbEvaluator();//渐变色计算类
        // 获得自定义属性，tab的数量
     ...
     * @param mTabColors
     */
    public void setmTabColors(List<Integer> mTabColors) {
    ...
    public void setViewPager(ViewPager mViewPager, final int pos) {
        ...
        setBackgroundColor(mTabColors.get(mViewPager.getCurrentItem()));
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                setBackgroundColor(mTabColors.get(position));
                // 回调
            ...
            public void onPageScrolled(int position, float positionOffset,
                ...
                if (position < mTabColors.size() - 1) {
                    setBackgroundColor((int) argbEvaluator.evaluate(positionOffset, mTabColors.get(position), mTabColors.get(position + 1)));
                }
                // 回调
                if (onPageChangeListener != null) {
