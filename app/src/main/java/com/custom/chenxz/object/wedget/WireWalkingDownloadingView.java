 ...
 * 技术交流qq群:277582728
 */
public class WireWalkingDownloadingView extends View {
    ...
    public WireWalkingDownloadingView(Context context) {
        this(context, null);
    }

    public WireWalkingDownloadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WireWalkingDownloadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.WireWalkingDownloadingView, defStyleAttr, 0);
        mArrowColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_arrow_color, DEFAULT_ARROW_COLOR);
        mLoadingCircleBackColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_loading_circle_back_color, DEFAULT_LOADING_CIRCLE_BG_COLOR);
        mLoadingLineColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_loading_line_color, DEFAULT_LOADING_LINE_COLOR);
        mProgressLineColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_progress_line_color, DEFAULT_PROGRESS_LINE_LEFT_COLOR);
        mProgressTextColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_progress_text_color, DEFAULT_PROGRESS_TEXT_COLOR);
        mDoneTextColor = typedArray.getColor(R.styleable.WireWalkingDownloadingView_done_text_color, DEFAULT_DONE_PROGRESS_TEXT_COLOR);
